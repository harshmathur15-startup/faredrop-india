...
const SECTIONS: Section[] = [
  {
    ...
    blocks: [
      ...
      { type: 'p', lead: 'Commencement and application.', text: 'Travelbaby was commissioned and began providing its Platform and services before publication of this consolidated version. To the extent permitted by applicable law, these Terms record the basis on which the Platform and services have been provided from the commencement of Travelbaby’s operations. The version available when a user accesses, purchases or continues to use a service governs that use. A new or materially more onerous provision will not retrospectively remove an accrued statutory right or impose a new payment obligation for a completed transaction.' },
